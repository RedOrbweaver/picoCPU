...
class MultiLine : public Object, public Geometric
{
    ...
    MultiLine(EntityManager* manager, GeometryManager* geometry_manager, uint8_t color, shared_ptr<GeometryManager::Geometry> geometry, bool visible=false, uint8_t layer=0, uint8_t rotation=0, vec2<int> position = {0,0})
